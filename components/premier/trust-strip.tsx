...
const PROOF_POINTS = [
  {
    title: 'Top Position',
    description: 'Appear in a premium search result for the metro and practice area you choose.',
  },
  {
    title: 'Maximum Exposure',
    description: 'Your profile is positioned where prospective clients are most likely to see it in the market you choose.',
  },
  {
      ...
      <div className="mx-auto w-full max-w-7xl px-5 sm:px-8">
        <Reveal x={-32}>
          <h2 className="max-w-2xl text-balance font-serif text-3xl font-normal leading-[1.1] tracking-[-0.02em] sm:text-4xl">
            A distinct visibility experience for Premier profiles.
          </h2>
        </Reveal>
        ...
        <div className="mt-20 flex flex-col gap-8 border-t border-line-dark/40 pt-14 lg:flex-row lg:items-end lg:justify-between">
          <Reveal x={-24}>
            <p className="max-w-xl text-balance font-serif text-2xl font-medium leading-snug tracking-[-0.01em] text-ivory sm:text-3xl">
              Position your Premier profile where it will be seen first.
            </p>
          </Reveal>
