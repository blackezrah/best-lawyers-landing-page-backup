...
export function VisibilityComparison() {
  return (
    <section id="premier-advantage" className="scroll-mt-24 relative overflow-hidden bg-ink text-ivory">
      <div className="mx-auto w-full max-w-7xl px-5 py-52 sm:px-8 sm:py-60 lg:py-72">
        <div className="mx-auto text-center">
          <Reveal x={-34}>
            <h2 className="mx-auto font-serif text-4xl font-normal leading-[1.05] tracking-[-0.02em] text-ivory sm:text-5xl xl:whitespace-nowrap">
          ...
          <div className="mx-auto mt-16 grid max-w-5xl gap-10 text-left md:grid-cols-[1.15fr_0.85fr] md:items-start lg:mt-20">
            <Reveal delay={0.08} x={-24}>
              <p className="text-pretty text-lg leading-relaxed text-ivory/72">
              ...
              <p className="mt-4 text-pretty text-lg leading-relaxed text-ivory/72">
